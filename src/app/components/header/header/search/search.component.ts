...
export class SearchComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        this.currentVehicleControl.valueChanges
            .pipe(
                switchMap((vehicleId) =>
                    this.vehiclesApi.userVehicles$.pipe(
                        map(
                            (vehicles) =>
        ...
        this.currentVehicle$.subscribe((vehicle) =>
            this.currentVehicleControl.setValue(vehicle ? vehicle.id : null, {
                emitEvent: false
            })
        );
        ...
        this.query$
            .pipe(
                distinctUntilChanged(),
                switchMap((query) =>
                    this.shopApi.getSearchSuggestions(query, {
                        limitProducts: 3,
                        limitCategories: 4
                    })
                ),
